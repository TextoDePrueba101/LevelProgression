...
public class languageFile {
	...
	public static void defaultAdd(String name) {
		if (name.equals("ESP_ARG")) {
			...
			config.addDefault("lvlShow", "Mostrar Niveles");
			config.addDefault("lvlHide", "Ocultar Niveles");
			...
			config.addDefault("guiList5", "Bloqueado hasta el nivel ");
			config.addDefault("guiList6", "Desbloqueado en el nivel ");
			...
			config.addDefault("info35", "Pies Rápidos");
			config.addDefault("info36", "Hay una pequeña probabilidad de que//esquives un ataque cuerpo a cuerpo");
			...
			config.addDefault("info117", "Si se tiene una espada en la mano secundaria,//ésta incrementa el daño final en (su daño base - 4).//Atacar cargado da absorción y efectos.");
			...
			config.addDefault("lvlShow", "Show Levels");
			config.addDefault("lvlHide", "Hide Levels");
			...
			config.addDefault("guiList5", "Locked until level ");
			config.addDefault("guiList6", "Unlocked at level ");
			...
			config.addDefault("info35", "Fast Feet");
			config.addDefault("info36", "There's a small chance of//dodging physical attacks");
			...
			config.addDefault("info117", "If you have a sword in your opposite hand,//you will add (sword's base damage - 4)//to the final damage.//Attacking gives absorption and effects.");
